 ...
 */
if ( ! class_exists( 'voice_blog_My_Dropdown_Category_Control' ) ) :
class voice_blog_My_Dropdown_Category_Control extends WP_Customize_Control {
...
protected function render_content() {
    ...
    $dropdown_args = wp_parse_args( $this->dropdown_args, array(
        'taxonomy'          => 'category',
        'show_option_all'    => __('Among All category ','voice-blog'),
        'orderby'            => 'name',
        'order'             => 'ASC',
        'show_count'        => 1,
        'hide_empty'        => 1,

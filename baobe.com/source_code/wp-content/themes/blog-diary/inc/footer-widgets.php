...
class Blog_Diary_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'blog_diary';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'blog-diary' ), $i ),
...
// Initialize.
$blog_diary_footer_widgets = new Blog_Diary_Footer_Widgets();
